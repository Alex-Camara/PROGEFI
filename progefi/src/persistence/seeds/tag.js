  ...
  return knex('tag').del()
    .then(function () {
      ...
      return knex('tag').insert([
        { tag: "altitude", tagBefore: null, tagAfter: 'msnm', model: 'location', retrieveMethod: 'getAltitude', templateId: 1},
                { tag: "device", tagBefore: null, tagAfter: null, model: 'device', retrieveMethod: 'getName', templateId: 1 },
                { tag: "longitude", tagBefore: null, tagAfter: null, model: 'location', retrieveMethod: 'getLongitude', templateId: 1 },
                { tag: "latitude", tagBefore: null, tagAfter: null, model: 'location', retrieveMethod: 'getLatitude', templateId: 1 },
                ...
                { tag: "scientificName", tagBefore: null, tagAfter: null, model: 'speciesData', retrieveMethod: 'getScientificName', templateId: 1 },
                { tag: "sex", tagBefore: null, tagAfter: null, model: 'speciesData', retrieveMethod: 'getSexName', templateId: 1 },
                { tag: "lifeStage", tagBefore: null, tagAfter: null, model: 'speciesData', retrieveMethod: 'getLifeStageName', templateId: 1 },
                { tag: "country", tagBefore: null, tagAfter: null, model: 'location', retrieveMethod: 'getCountry', templateId: 1 },
                { tag: "countryState", tagBefore: null, tagAfter: null, model: 'location', retrieveMethod: 'getCountryState', templateId: 1 },
                { tag: "municipality", tagBefore: null, tagAfter: null, model: 'location', retrieveMethod: 'getMunicipality', templateId: 1 },
                { tag: "locality", tagBefore: null, tagAfter: null, model: 'location', retrieveMethod: 'getLocality', templateId: 1 },
                { tag: "curator", tagBefore: 'Curador:', tagAfter: null, model: 'curator', retrieveMethod: 'getName', templateId: 1 },
                { tag: "altitude", tagBefore: null, tagAfter: 'msnm', model: 'location', retrieveMethod: 'getAltitude', templateId: 2},
                { tag: "device", tagBefore: null, tagAfter: null, model: 'device', retrieveMethod: 'getName', templateId: 2 },
                { tag: "longitude", tagBefore: null, tagAfter: null, model: 'location', retrieveMethod: 'getLongitude', templateId: 2 },
                { tag: "latitude", tagBefore: null, tagAfter: null, model: 'location', retrieveMethod: 'getLatitude', templateId: 2 },
                ...
                { tag: "scientificName", tagBefore: null, tagAfter: null, model: 'speciesData', retrieveMethod: 'getScientificName', templateId: 2 },
                { tag: "sex", tagBefore: null, tagAfter: null, model: 'speciesData', retrieveMethod: 'getSexName', templateId: 2 },
                { tag: "lifeStage", tagBefore: null, tagAfter: null, model: 'speciesData', retrieveMethod: 'getLifeStageName', templateId: 2 },
                { tag: "country", tagBefore: null, tagAfter: null, model: 'location', retrieveMethod: 'getCountry', templateId: 2 },
                { tag: "countryState", tagBefore: null, tagAfter: null, model: 'location', retrieveMethod: 'getCountryState', templateId: 2 },
                { tag: "municipality", tagBefore: null, tagAfter: null, model: 'location', retrieveMethod: 'getMunicipality', templateId: 2 },
                { tag: "locality", tagBefore: null, tagAfter: null, model: 'location', retrieveMethod: 'getLocality', templateId: 2 },
